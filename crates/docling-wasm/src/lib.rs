...
pub fn supported_extensions() -> String {
    ...
    let exts = [
        ...
        "sdw", "sda", "sdd", "vor", "abw", "zabw", "awt", "wpd", "wp", "wp5", "wp6", "wpt", "wps",
        "dbf", "dif", "slk", "sylk", "wk1", "wk2", "wk3", "wk4", "wks", "wrk", "123", "wq1", "wq2",
        "wb1", "wb2", "wb3", "qpw", "xlr", "vtt", "tex", "latex", "eml", "epub", "mhtml", "mht",
        "rtf", "vsdx", "vsdm", "pdf",
    ];
