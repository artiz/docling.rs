...
This is a word document and this is an inline equation:  \$A= \textbackslash{}pi r\textasciicircum{}\{2\}\$ .

\begin{itemize}
\item First item with inline equation:  \$A= \textbackslash{}pi r\textasciicircum{}\{2\}\$ is the area formula.
\item Second item with equations:  \$E=mc\textasciicircum{}\{2\}\$  and  \$F=ma\$ are physics formulas.
\item The formula  \$a\textasciicircum{}\{2\}+b\textasciicircum{}\{2\}=c\textasciicircum{}\{2\}\$ is the Pythagorean theorem.
\end{itemize}
...
This is a word document and this is an inline equation:  \$A= \textbackslash{}pi r\textasciicircum{}\{2\}\$ . If instead, I want an equation by line, I can do this:
...
This is a word document and these are inline equations:  \$N\_\{s\}\textasciicircum{}\{H\}\$ / \$N\_\{s\}\textasciicircum{}\{P\}\$ ​. If instead, I want an equation by line, I can do this:
