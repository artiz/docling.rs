...
\begin{itemize}
\item \textbf{First} : Lorem ipsum.
\item \textbf{Second} : Dolor \texttt{sit} amet.
\end{itemize}

Some \texttt{formatted_code}

\section{\textit{Partially formatted} heading to\_escape \texttt{not_to_escape}}

\href{https://en.wikipedia.org/wiki/Albert\_Einstein}{\$\$E=mc\textasciicircum{}2\$\$}
