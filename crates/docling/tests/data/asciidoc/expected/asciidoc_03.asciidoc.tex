...
\begin{figure}[h]
% image
\caption{Procedure . Right-click the bookmark in the side bar. . Select *Rename…*. +}
\end{figure}

\begin{figure}[h]
% image
\caption{ In the *Name* field, enter the new name for the bookmark. +}
\end{figure}

\begin{figure}[h]
% image
\caption{ Click btn:[Rename]. .Verification}
\end{figure}
