...
\title{LIGHT EMITTING DEVICE AND PLANT CULTIVATION METHOD}
...
\subsubsection{Light Emitting Device}
...
\subsubsection{Light Emitting Element}
...
\subsubsection{Fluorescent Member}
...
\subsubsection{First Fluorescent Material}
...
\subsubsection{Second Fluorescent Material}
...
\subsubsection{Production Method of Second Fluorescent Material}
...
\subsubsection{Compound Containing Rare Earth Element Ln}
...
\subsubsection{Compound Containing M}
...
\subsubsection{Compound Containing Ce and Compound Containing Cr}
...
\subsubsection{Other Fluorescent Materials}
...
\subsubsection{Plant Cultivation Method}
...
\subsection{Comparative Example 1}
...
\subsubsection{Photon Flux Density}
...
\subsubsection{Plant Cultivation Test}
...
\subsubsection{First Growth Period}
...
\subsubsection{Second Growth Period}
...
\subsubsection{Measurement of Fresh Weight (Edible Part)}
...
\subsubsection{Measurement of Nitrate Nitrogen Content}
...
\hline
 & TABLE 1 & TABLE 1 & TABLE 1 & TABLE 1 & TABLE 1 & TABLE 1 &  &  &  \\ \hline
 & Fluorescent material & Fluorescent material &  &  &  &  &  &  &  \\ \hline
 & (parts by mass) & (parts by mass) & Photon flux & Photon flux & Photon flux & Ratio of & Ratio of &  &  \\ \hline
 & First fluorescent & Second fluorescent & density & density & density & photon & photon & Fresh weight & Nitrate nitrogen \\ \hline
 & material & material & (μmol · m−2 · s−1) & (μmol · m−2 · s−1) & (μmol · m−2 · s−1) & flux densities & flux densities & (Edible part) & content \\ \hline
 & (MGF/CASN = 95:5) & (YAG: Ce, Cr) & B & R & FR & R/B & R/FR & (g) & (mg/100 g) \\ \hline
Comparative & — & — & 35.5 & 88.8 & 0.0 & 2.5 & — & 26.2 & 361.2 \\ \hline
Example 1 &  &  &  &  &  &  &  &  &  \\ \hline
Example 1 & 60 & — & 31.5 & 74.9 & 12.6 & 2.4 & 6.0 & 35.4 & 430.8 \\ \hline
Example 2 & 50 & 10 & 28.5 & 67.1 & 21.7 & 2.4 & 3.1 & 34.0 & 450.0 \\ \hline
Example 3 & 40 & 20 & 25.8 & 62.0 & 28.7 & 2.4 & 2.2 & 33.8 & 452.4 \\ \hline
Example 4 & 30 & 30 & 26.8 & 54.7 & 33.5 & 2.0 & 1.6 & 33.8 & 345.0 \\ \hline
Example 5 & 25 & 39 & 23.4 & 52.8 & 38.1 & 2.3 & 1.4 & 28.8 & 307.2 \\ \hline
\end{tabular}
\end{table}
