...
\title{10-Q GROOVE BOTANICALS, INC. 2025-12-31}

\begin{document}

\maketitle

\textbf{NOTE 1 - ORGANIZATION AND OPERATIONS}

\textbf{Current Operations}
...
\textbf{NOTE 2 - SUMMARY OF SIGNIFICANT ACCOUNTING POLICIES}
...
\textbf{Recent Accounting Standard Adopted} :
...
\textbf{Recent Accounting Standard Not Yet Adopted:}
...
\textbf{NOTE 5 - RELATED PARTY TRANSACTIONS}
...
\hline
Schedule of dividends payable, related party &  &  &  &  &  &  &  &  \\ \hline
 &  & \textbf{December 31, 2025}  \textbf{\$} & \textbf{December 31, 2025}  \textbf{\$} &  &  & \textbf{March 31, 2025}  \textbf{\$} & \textbf{March 31, 2025}  \textbf{\$} &  \\ \hline
Dividends payable &  &  & 399,506 &  &  &  & 290,550 &  \\ \hline
Dividends payable, related party &  &  & 201,286 &  &  &  & 146,390 &  \\ \hline
\end{tabular}
\end{table}
...
\textbf{NOTE 8 - COMMITMENTS AND CONTINGENCIES}
...
\textbf{NOTE 9 - SUBSEQUENT EVENTS}
