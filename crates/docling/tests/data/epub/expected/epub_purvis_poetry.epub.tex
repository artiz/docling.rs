...
By \textbf{Sarah Louisa Forten Purvis} .
...
\begin{figure}[h]
% image
\caption{The Standard Ebooks logo.}
\end{figure}

This ebook is the product of many hours of hard work by volunteers for \href{https://standardebooks.org/}{Standard Ebooks} , and builds on the hard work of other literature lovers made possible by the public domain.

This particular ebook is based on digital scans from the \href{https://standardebooks.org/ebooks/sarah-louisa-forten-purvis/poetry\#page-scans}{Internet Archive} .

The source text and artwork in this ebook are believed to be in the United States public domain; that is, they are believed to be free of copyright restrictions in the United States. They may still be copyrighted in other countries, so users located outside of the United States must check their local laws before using this ebook. The creators of, and contributors to, this ebook dedicate their contributions to the worldwide public domain via the terms in the \href{https://creativecommons.org/publicdomain/zero/1.0/}{CC0 1.0 Universal Public Domain Dedication} . For full license information, see the \href{uncopyright.xhtml}{Uncopyright} at the end of this ebook.

Standard Ebooks is a volunteer-driven project that produces ebook editions of public domain literature using modern typography, technology, and editorial standards, and distributes them free of cost. You can download this and other ebooks carefully produced for true book lovers at \href{https://standardebooks.org/}{standardebooks.org} .

\section{The Grave of the Slave}
...
\section{The Slave Girl's Address to Her Mother}
...
When thousands groan in hopeless \textit{slavery} ?
...
But \textit{these} were scenes he'll know no more-
He only \textit{feels} they've been.
...
To feel that \textit{his} is doomed to be
...
Since \textit{he} , my sweet-my gentle one,
...
Who claim the proud name of the " \textbf{home of the free} "!
...
Can the name of " \textbf{my country} "-the deeds which we sing-
...
\section{The Slave Girl's Farewell}
...
I knew not \textit{then} I was a slave,
...
\textit{Poetry} was compiled from poems published between 1831 and 1836 by \href{https://en.wikipedia.org/wiki/Sarah\_Louisa\_Forten\_Purvis}{Sarah Louisa Forten Purvis} .

This ebook was transcribed and produced for \href{https://standardebooks.org/}{Standard Ebooks} by \href{https://weijiarhymeswith.asia/}{Weijia Cheng} ,
and is based on digital scans from the \href{https://standardebooks.org/ebooks/sarah-louisa-forten-purvis/poetry\#page-scans}{Internet Archive} .

The cover page is adapted from \textit{Sunday Morning} ,
a painting completed in 1877 by \href{https://en.wikipedia.org/wiki/Thomas\_Waterman\_Wood}{Thomas Waterman Wood} .
The cover and title pages feature the \textbf{League Spartan} and \textbf{Sorts Mill Goudy} typefaces created in 2014 and 2009 by \href{https://www.theleagueofmoveabletype.com/}{The League of Moveable Type} .

This edition was released on \textbf{May 21, 2026, 6:29} \textbf{p.m.} and is based on \textbf{revision 936122b} .
The first edition of this ebook was released on
December 6, 2023, 8:52 p.m.
You can check for updates to this ebook, view its revision history, or download it for different ereading systems at \href{https://standardebooks.org/ebooks/sarah-louisa-forten-purvis/poetry}{standardebooks.org/ebooks/sarah-louisa-forten-purvis/poetry} .

The volunteer-driven Standard Ebooks project relies on readers like you to submit typos, corrections, and other improvements. Anyone can contribute at \href{https://standardebooks.org/}{standardebooks.org} .
...
Non-authorship activities performed on items that are in the public domain-so-called "sweat of the brow" work-don't create a new copyright. That means that nobody can claim a new copyright on an item that is in the public domain for, among other things, work like digitization, markup, or typography. Regardless, the contributors to this ebook release their contributions under the terms in the \href{https://creativecommons.org/publicdomain/zero/1.0/}{CC0 1.0 Universal Public Domain Dedication} , thus dedicating to the worldwide public domain all of the work they've done on this ebook, including but not limited to metadata, the titlepage, imprint, colophon, this Uncopyright, and any changes or enhancements to, or markup on, the original text and artwork. This dedication doesn't change the copyright status of the source text or artwork. We make this dedication in the interest of enriching our global cultural heritage, to promote free and libre culture around the world, and to give back to the unrestricted culture that has given all of us so much.
