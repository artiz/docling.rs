...
|  Column A | Column B |
| - | - |
| This is a list: | This is a formatted list: |
| First Paragraph  Second Paragraph  Third paragraph before a numbered list | This is simple text with  **bold** ,  ~~strikethrough~~  and  *italic*  formatting with x 2  and H 2 O |
