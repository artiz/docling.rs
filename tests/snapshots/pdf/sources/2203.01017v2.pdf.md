...
9e. If the table cell under the identified row and column is not empty, extend its content with the content of the orphan cell.
...
|           | SumSq   | ANOVA - Df   |   ANOVA - FValue | Pr (>F)   |
|-----------|---------|--------------|------------------|-----------|
