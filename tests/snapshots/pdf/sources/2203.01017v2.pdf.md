...
where λ 2 [0, 1], and λ iou ; λ l 1 2 R are hyper-parameters.
...
where T a and T b represent tables in tree structure HTML format. EditDist denotes the tree-edit distance, and j T j represents the number of nodes in T .
