...
Ahmed S. Nassar IBM Research Rueschlikon, Switzerland ahn@zurich.ibm.com Michele Dolfi IBM Research Rueschlikon, Switzerland dol@zurich.ibm.com Peter Staar IBM Research Rueschlikon, Switzerland taa@zurich.ibm.com OPERATION (cont.) MODEL AY11236 Interpupil lary Sli de Adjustment Model AY11230 Model AY11234 Eyepiece SELECTING OBJECTIVE FOCUSING MAGNIFICATION 1. Turn the focusing knob away or toward Rotati ng Head 1. There are two objectives. The lower you until  a clear image is viewed. magnification objective has a greater 2. If the image is unclear,  adjust the Revolving Turret depth of field and view. height of the elevator up or down, 2. In order to observe the specimen then turn the focusing knob again. Stand easil y use the lower magnification objective first. Then, by rotating the ZOOM MAGNIFICATION Objecti ves case, the magnification can be 1. Turn the zoom magnification knob to changed. the desired magnification and field of view. Stage Coarse Adjustment CHANGING THE INTERPUPILLARY 2. In most situations, it is recommended Condenser Focusing Knob DISTANCE that you focus at the lowest Knob Fine 1. The distance between the observer's magnification, then move to a higher Lamp On/Of Adjustment Knob pupil s is the interpupil lary distance. magnification and re-focus as Stage Cli p 2. To adjust the interpupil lary distance necessary. Swit ch Adjustment rotate the prism caps until  both eyes 3. If the image is not clear to both eyes coincide with the image in the at the same time, the diopter ring may eyepiece. need adjustment. Power F Cord OCUSING DIOPTER RING ADJUSTMENT Lamp 1. Remove the lens protective cover. 1. To adjust the eyepiece for viewing with 2. Place the specimen on the working or without eyeglasses and for stage. differences in acuity between the right Model AY11236 3. Focus the specimen with the left eye and left eyes, fol ow the fol owing first whil e turning the focus knob until steps: the image appears clear and sharp. a. Observe an image through the left MICROSCOPE USAGE 4. Rotate the right eyepiece ring until  the eyepiece and bring a specific point images in each eyepiece coincide and into focus using the focus knob. are sharp and clear. b. By turning the diopter ring BARSKA Model AY11236 is a powerful fixed power compound adjustment for the left eyepiece, CHANGING THE BULB bring the same point into sharp microscope designed for biological studies such as specimen 1. Disconnect the power cord. focus. examination. It can also be used for examining bacteria and 2. When the bulb is cool, remove the c.Then bring the same point into for general cli nical and medical studies and other scientific uses. obli que il luminator cap and remove focus through the right eyepiece the halogen bulb with cap. by turning the right diopter ring. CONSTRUCTION 3. Replace with a new halogen bulb. d.With more than one viewer,  each 4. Open the window in the base plate and viewer should note their own replace the halogen lamp or diopter ring position for the left fluorescent lamp of transmitted and right eyepieces, then before BARSKA Model AY11236 is a fixed power compound microscope. il luminator. viewing set the diopter ring It is constructed with two optical paths at the same angle. It is adjustments to that setting. USING THE VERTICAL TUBE - equipped with transmitted il lumination. By using this instrument, MODELS AY11230/11234 CHANGING THE BULB the user can observe specimens at magnification from 40x to 1. Disconnect the power cord from the 1. The verti cal tube can be used for electrical outlet. 1000x by selecting the desired objective lens. Coarse and fine instructi onal viewing or to photograph 2. When the bulb is cool, remove the focus adjustments provide accuracy and image detail . The rotating the image wit h a digit al camera or a obli que il luminator cap and remove head al ows the user to position the eyepieces for maximum micro TV unit the halogen bulb with cap. viewing comfort and easy access to al  adjustment knobs. 2. Loosen the retenti on screw, then rotate 3. Replace with a new halogen bulb. the adjustment ring to change the 4. Open the window in the base plate length of the verti cal tube. and replace the halogen lamp or 3. Make sure that both the images in fluorescent lamp of transmitted il luminator. 13 14
