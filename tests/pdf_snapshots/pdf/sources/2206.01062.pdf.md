...
document-wise and page-wise split for different label sets. Naive page-wise split will result in ~10% point improvement.
...
| PubLayNet (PLN) confidence.6 | Figure | 96 | 43 | 23 |
| PubLayNet (PLN) confidence.6 | Sec-header | 87 | - | 32 |
|  | Table | 95 | 24 | 49 |
|  | Text | 96 | - | 42 |
|  | total | 93 | 34 | 30 |
