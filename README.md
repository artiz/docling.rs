...
files in [`docs/MIGRATION.md`](./docs/MIGRATION.md). LaTeX's JSON differs on
`example_01.tex` by the same one word as its Markdown (¹). Markdown is exact on
